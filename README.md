...
| Name                                                                  | Stars                                                                     | Description                                                                                            |
| --------------------------------------------------------------------- | ------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| [ClawBench](https://github.com/TIGER-AI-Lab/ClawBench)               | ![](https://img.shields.io/github/stars/TIGER-AI-Lab/ClawBench)            | Live-web browser-agent benchmark with 283 V1+V2 tasks across 163 sites and five-layer execution traces |
