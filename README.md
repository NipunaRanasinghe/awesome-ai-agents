...
| [Allowly MCP](https://github.com/Allowly-AI/allowly-mcp)                          | ![](https://img.shields.io/github/stars/Allowly-AI/allowly-mcp)             | TypeScript MCP middleware for hosted policy checks, with confirmation and escalation responses before tool execution |
