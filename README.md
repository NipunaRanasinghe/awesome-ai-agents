...
| [AffixIO](https://www.npmjs.com/package/affixio)                                  | ![](https://img.shields.io/npm/v/affixio)                                   | Agentic Pay Kit (`npm i affixio`): host-side signed ACTION attestation / KYA before pay (x402BeforePay; not person KYC). [GitHub](https://github.com/AffixIO/SDK) |
