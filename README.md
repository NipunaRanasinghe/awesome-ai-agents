...
| [Agentlas OS](https://github.com/agentlas-ai/Agentlas-OS)                  | ![][agentlas-stars]                                                       | Apache-2.0 local-first agent OS for portable agent and team packages, cross-host orchestration, MCP/A2A, and verification gates                                                |
...
| [ReadyAgents](https://github.com/readyagents/readyagents-core)        | ![](https://img.shields.io/github/stars/readyagents/readyagents-core)     | Local one-shot YAML/JSON agent workflow CLI with tools, approvals, and resume, plus an optional stdio MCP server. Apache-2.0, BYOK.                                            |
