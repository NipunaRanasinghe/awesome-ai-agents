...
| [OIXA Protocol](https://github.com/ivoshemi-sys/oixa-protocol)             | ![](https://img.shields.io/github/stars/ivoshemi-sys/oixa-protocol)       | Agent-to-agent economic marketplace on Base Mainnet. Reverse auctions, USDC on-chain escrow, auto-released on delivery. LangChain, CrewAI, AutoGen, MCP, A2A. `pip install oixa-protocol` |
