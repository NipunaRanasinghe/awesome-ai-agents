...
| Name                                                                  | Stars                                                                     | Description                                                                                            |
| --------------------------------------------------------------------- | ------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| [ClawBench](https://github.com/reacher-z/ClawBench)                   | ![](https://img.shields.io/github/stars/reacher-z/ClawBench)              | Live-web browser-agent benchmark with 153 write-heavy tasks and five-layer execution traces            |
